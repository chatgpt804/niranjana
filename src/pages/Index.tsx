...
const pages: PageContent[] = [
  {
    id: 1,
    type: 'cover',
    title: 'A Tribute to Niranjana Mam',
    ...
    imageAlt: 'Kaulii Gang with Niranjana Mam'
  },
  {
    id: 2,
    type: 'text',
  ...
  },
  {
    ...
    type: 'gallery',
    title: 'Photo Gallery',
    content: 'Precious moments captured with Niranjana Mam throughout our journey together.',
    images: [
      {
        url: 'https://i.ibb.co/9HMCFt0V/467170439-1213288213116320-3431643718854136907-n.jpg',
